...
public class UserInfoDbHelper extends SQLiteOpenHelper {
    ...
    public String[][] getAllUsersData(Context context) {
        ...
        try {
            ...
            if (cursor.moveToFirst()) data = new String[cursor.getColumnCount()][cursor.getCount()];
            int i = 0;
            do {
                data[cursor.getColumnIndex(UsersContract.UserInfo._ID)][i] = cursor.getString
                        (cursor.getColumnIndex(UsersContract.UserInfo._ID));
                data[cursor.getColumnIndex(UsersContract.UserInfo.COLUMN_FIRSTNAME)][i] = cursor.getString
                        (cursor.getColumnIndex(UsersContract.UserInfo.COLUMN_FIRSTNAME));
                data[cursor.getColumnIndex(UsersContract.UserInfo.COLUMN_LASTNAME)][i] = cursor.getString
                        (cursor.getColumnIndex(UsersContract.UserInfo.COLUMN_LASTNAME));
                data[cursor.getColumnIndex(UsersContract.UserInfo.COLUMN_DATEREGISTER)][i] = cursor.getString
                        (cursor.getColumnIndex(UsersContract.UserInfo.COLUMN_DATEREGISTER));
                data[cursor.getColumnIndex(UsersContract.UserInfo.COLUMN_SCORE)][i] = cursor.getString
                        (cursor.getColumnIndex(UsersContract.UserInfo.COLUMN_SCORE));
                data[cursor.getColumnIndex(UsersContract.UserInfo.COLUMN_RANK)][i] = cursor.getString
                        (cursor.getColumnIndex(UsersContract.UserInfo.COLUMN_RANK));
                i++;
